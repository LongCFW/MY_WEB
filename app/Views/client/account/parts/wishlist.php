...
<div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
    ...
    <span class="text-muted small"><?= isset($totalPages) ? "Trang $pageNum / $totalPages" : '' ?></span>
</div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-3 overflow-hidden position-relative group-hover" id="wishlist-item-<?= $item['variant_id'] ?>">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-8 col-md-9 col-lg-10">
                        <div class="card-body py-2 pe-5"> <button class="btn btn-sm btn-light rounded-circle position-absolute top-0 end-0 m-2 text-secondary hover-danger shadow-sm" 
