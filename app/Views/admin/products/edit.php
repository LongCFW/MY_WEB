...
<div class="card shadow-sm border-0 rounded-lg">
    <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
        <h4 class="mb-0 font-weight-bold text-warning"><i class="fas fa-edit mr-2"></i> Cập nhật sản phẩm: <?= $product['name'] ?></h4>
    </div>
    <div class="card-body p-4">
        <form action="/MY_WEB/public/admin/product/update/<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control-file border p-2 rounded w-100 mb-2">
                        <?php if (!empty($product['image_url'])): ?>
                            <img src="/MY_WEB/public/<?= $product['image_url'] ?>" width="100" class="img-thumbnail rounded">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm font-weight-bold">Cập nhật</button>
            </div>
        </form>
    </div>
</div>
